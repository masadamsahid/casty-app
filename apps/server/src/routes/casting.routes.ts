...
import { getCastingsHandler, getCastingHandler, createCastingHandler, updateCastingHandler, deleteCastingHandler, getCategoriesHandler, getMyCastingsHandler, getCastingApplicationsHandler } from "../handlers/casting.handler";
...
castingRoutes.get("/:id/applications", authMiddleware, getCastingApplicationsHandler);
